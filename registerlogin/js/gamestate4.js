...
tetrisPlus.gameState4 = {
    ...
    preload:function(){
        ...
        //SOUNDS
        tetrisPlus.game.load.audio('backgroundMusic', 'assets/sounds/Level5.mp3')
    ...
    update:function(){        
        ...
        {
            //GANAR
            if((Player.y > (this.game.world.centerY + 124)) && (Player.y < (this.game.world.centerY + 150)))
            {
