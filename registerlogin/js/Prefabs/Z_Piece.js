...
tetrisPlus.Z_Piece = function(game, x1, y1, startj, starti, GridTetris)
{
...
tetrisPlus.Z_Piece.prototype.startGrid=function()
{
    //INICIAMOS LA PIEZA EN EL GRID
    this.GridTetris[this.starti][this.startj]=1;
    this.GridTetris[this.starti][this.startj-1]=2;
    this.GridTetris[this.starti+1][this.startj]=3;
    this.GridTetris[this.starti+1][this.startj+1]=4;
};

tetrisPlus.Z_Piece.prototype.move=function(direction, distance)
{
    this.contDer=0;
    this.contIzq=0;
...
tetrisPlus.Z_Piece.prototype.rotate=function(currentRotation)
{
    ...
    if(!this.cantMoveDown)
    {
        ...
        {
            if(this.GridTetris[this.previ1][this.prevj1]!=5 && this.GridTetris[this.previ2+1][this.prevj2+1]!=5 && this.GridTetris[this.previ3-1][this.prevj3+1]!=5 && this.GridTetris[this.previ4-2][this.prevj4]!=5)
                {
                    //console.log("1");
                    this.angle=-90;
                    this.RotFlag=true;
        ...
        if(this.RotFlag)
        {
           if(currentRotation==1 || currentRotation==3)
            {            
                ...
                this.GridTetris[this.previ4-2][this.prevj4]=4;
            }
            else 
            {
                this.GridTetris[this.previ1][this.prevj1]=null;
