...
tetrisPlus.L_Piece = function(game, x1, y1, startj, starti, GridTetris)
{
    //Phaser.Sprite.call(this,game,x1,y1,'T');
    //Phaser.Sprite.call(this,game,x2,y2,'T');
    Phaser.Sprite.call(this,game,x1,y1,'L_Complete');
    this.scale.setTo(2);
    this.x1=x1;
    this.y1=y1;
    this.starti=starti;
...
tetrisPlus.L_Piece.prototype = Object.create(Phaser.Sprite.prototype);
tetrisPlus.L_Piece.prototype.constructor = tetrisPlus.L_Piece;
tetrisPlus.L_Piece.prototype.startGrid=function()
{
...
tetrisPlus.L_Piece.prototype.move=function(direction, distance)
{
    this.contDer=0;
    this.contIzq=0;
...
tetrisPlus.L_Piece.prototype.rotate=function(currentRotation)
{
    ...
    if(!this.cantMoveDown)
    {
        ...
        {
            if(this.GridTetris[this.previ1][this.prevj1]!=5 && this.GridTetris[this.previ2+1][this.prevj2+1]!=5 && this.GridTetris[this.previ3][this.prevj3+2]!=5 && this.GridTetris[this.previ4-1][this.prevj4-1]!=5)
                {
                    //console.log("1");
                    this.angle=-90;
                    this.RotFlag=true;
        ...
        {
            if(this.GridTetris[this.previ1][this.prevj1]!=5 && this.GridTetris[this.previ2-1][this.prevj2+1]!=5 && this.GridTetris[this.previ3-2][this.prevj3]!=5 && this.GridTetris[this.previ4+1][this.prevj4-1]!=5)
                {
                    //console.log("2");
                    this.angle=-180;
                    this.RotFlag=true;
