...
tetrisPlus.T_Piece = function(game, x1, y1, startj, starti, GridTetris)
{
...
tetrisPlus.T_Piece.prototype.startGrid=function()
{
    //INICIAMOS LA PIEZA EN EL GRID
    this.GridTetris[this.starti][this.startj]=1;
    this.GridTetris[this.starti+1][this.startj]=2;
    this.GridTetris[this.starti][this.startj-1]=3;
...
tetrisPlus.T_Piece.prototype.rotate=function(currentRotation)
{
   //SETEAMOS EL VALOR DE LA FLAG
    ...
    if(!this.cantMoveDown)
    {
        ...
        {
            if(this.GridTetris[this.previ1][this.prevj1]!=5 && this.GridTetris[this.previ2-1][this.prevj2+1]!=5 && this.GridTetris[this.previ3+1][this.prevj3+1]!=5 && this.GridTetris[this.previ4-1][this.prevj4-1]!=5)
                {
                    console.log("1");
                    this.angle=-90;
                    this.RotFlag=true;
