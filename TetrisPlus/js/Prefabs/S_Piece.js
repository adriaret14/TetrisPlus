...
tetrisPlus.S_Piece = function(game, x1, y1, startj, starti, GridTetris)
{
...
tetrisPlus.S_Piece.prototype.startGrid=function()
{
...
tetrisPlus.S_Piece.prototype.move=function(direction, distance)
{
    this.contDer=0;
    this.contIzq=0;
...
tetrisPlus.S_Piece.prototype.rotate=function(currentRotation)
{
    ...
    if(!this.cantMoveDown)
    {
        ...
        {
            if(this.GridTetris[this.previ1][this.prevj1]!=5 && this.GridTetris[this.previ2-1][this.prevj2-1]!=5 && this.GridTetris[this.previ3-1][this.prevj3+1]!=5 && this.GridTetris[this.previ4][this.prevj4+2]!=5)
                {
                    //console.log("1");
                    this.angle=-90;
                    this.RotFlag=true;
           ...
           if(currentRotation==1 || currentRotation==3)
            {
                ...
                this.GridTetris[this.previ4][this.prevj4+2]=4;
            }
            else 
            {
                this.GridTetris[this.previ1][this.prevj1]=null;
